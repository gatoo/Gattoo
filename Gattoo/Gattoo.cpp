...
// Gattoo.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CGattooApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CGattooApp::OnAppAbout)
...
// CGattooApp initialization

BOOL CGattooApp::InitInstance()
{
...
void CGattooApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// CGattooApp customization load/save methods

void CGattooApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CGattooApp::LoadCustomState()
{
}

void CGattooApp::SaveCustomState()
{
}
